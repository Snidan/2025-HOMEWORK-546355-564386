...
//	}
	...
	public Attrezzo getAttrezzo(String nomeAttrezzo) {
	    if (nomeAttrezzo == null || numeroAttrezzi == 0) {
	        return null; // Se non ci sono attrezzi, restituisci null
	    }

	    for (int i = 0; i < numeroAttrezzi; i++) {
	        if (attrezzi[i] != null && attrezzi[i].getNome().equals(nomeAttrezzo)) {
	            return attrezzi[i]; // Restituisce l'attrezzo trovato
	        }
	    }

	    return null; // Se l'attrezzo non viene trovato, restituisce null
	}
